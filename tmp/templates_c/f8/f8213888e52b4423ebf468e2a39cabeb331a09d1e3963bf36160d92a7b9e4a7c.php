            ...
            <div class=\"visitor-profile-visits-info\">
                <div class=\"visitor-profile-visits-container\">
                    <ol class=\"visitor-profile-visits\">
                        ";
            // line 157
            $this->loadTemplate("@Live/getVisitList.twig", "@Live/getVisitorProfilePopup.twig", 157)->display(array_merge($context, array("visits" => $this->getAttribute(($context["visitorData"] ?? $this->getContext($context, "visitorData")), "lastVisits", array()), "startCounter" => 1)));
            // line 158
            echo "                    </ol>
                </div>
...
{% endif %}", "@Live/getVisitorProfilePopup.twig", "/var/www/html/php-piwik/plugins/Live/templates/getVisitorProfilePopup.twig");
    }
}
