...
<script>\$(document).ready(function () { require('{{ jsNamespace }}').{{ jsClass }}.initElements(); });</script>", "@CoreHome\\_uiControl.twig", "/var/www/html/php-piwik/plugins/CoreHome/templates/_uiControl.twig");
    }
}
