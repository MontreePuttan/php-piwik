...
class __TwigTemplate_d73b000505a3dd3466ec7d74a0bb365922951b4a6b2bc78fa8254c165cb18be0 extends Twig_Template
{
    ...
    <div piwik-form ng-controller=\"AnonymizeIpController as anonymizeIp\">
        ...
        <div piwik-field uicontrol=\"checkbox\" name=\"anonymizeIpSettings\"
            ...
            echo "\"
             value=\"";
            // line 24
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute(($context["anonymizeIP"] ?? $this->getContext($context, "anonymizeIP")), "enabled", array()), "html", null, true);
            echo "\"
             inline-help=\"";
            // line 25
        ...
        <div ng-show=\"anonymizeIp.enabled\">
            ...
            echo "\"
                 value=\"";
            // line 32
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute(($context["anonymizeIP"] ?? $this->getContext($context, "anonymizeIP")), "maskLength", array()), "html", null, true);
            echo "\"
                 options=\"";
            // line 33
            ...
            echo "\"
                 value=\"";
            // line 40
            if ($this->getAttribute(($context["anonymizeIP"] ?? $this->getContext($context, "anonymizeIP")), "useAnonymizedIpForVisitEnrichment", array())) {
                echo "1";
            } else {
                echo "0";
            }
        ...
        <div piwik-form
            ...
            <div id=\"deleteLogSettingEnabled\">
                ...
                <div id=\"deleteLogInfoInlineHelp\" class=\"inline-help-node\">
                    ";
                // line 80
                echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("PrivacyManager_DeleteLogInfo", $this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "deleteTables", array())));
                echo "
                    ";
                // line 81
                if ( !($context["canDeleteLogActions"] ?? $this->getContext($context, "canDeleteLogActions"))) {
                    // line 82
                    echo "                        <br/><br/>
                        ";
                    // line 83
                    echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("PrivacyManager_CannotLockSoDeleteLogActions", ($context["dbUser"] ?? $this->getContext($context, "dbUser")))), "html", null, true);
                    echo "
                    ";
                }
                // line 85
                ...
                echo "\"
                     value=\"";
                // line 91
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "config", array()), "delete_logs_enable", array()), "html", null, true);
                echo "\"
            ...
            <div id=\"deleteLogSettings\" ng-show=\"deleteOldLogs.enabled\">
                ...
                echo ")\"
                     value=\"";
                // line 108
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "config", array()), "delete_logs_older_than", array()), "html", null, true);
                echo "\"
                     inline-help=\"";
                // line 109
        ...
        <div piwik-form
            ...
            <div id=\"deleteReportsSettingEnabled\">
                ...
                echo "\"
                     value=\"";
                // line 130
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "config", array()), "delete_reports_enable", array()), "html", null, true);
                echo "\"
                     inline-help=\"";
                // line 131
                ...
                echo "
                    <span ng-show=\"deleteReports.enabled\">
                        ...
                        ";
                // line 139
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("PrivacyManager_DeleteReportsInfo2", ($context["deleteOldLogs"] ?? $this->getContext($context, "deleteOldLogs")))), "html", null, true);
                echo "<br/><br/>
                        ";
                // line 140
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("PrivacyManager_DeleteReportsInfo3", ($context["deleteOldLogs"] ?? $this->getContext($context, "deleteOldLogs")))), "html", null, true);
                echo "
                    </span>
                </div>
            ...
            <div id=\"deleteReportsSettings\" ng-show=\"deleteReports.enabled\">
                ...
                echo ")\"
                     value=\"";
                // line 152
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "config", array()), "delete_reports_older_than", array()), "html", null, true);
                echo "\"
                     inline-help=\"";
                // line 153
                ...
                echo ")\"
                     value=\"";
                // line 160
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "config", array()), "delete_reports_keep_basic_metrics", array()), "html", null, true);
                echo "\"
                     inline-help=\"";
                // line 161
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("PrivacyManager_DeleteReportsDetailedInfo", "archive_numeric_*", "archive_blob_*")), "html_attr");
                ...
                echo "\"
                         value=\"";
                // line 173
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "config", array()), "delete_reports_keep_day_reports", array()), "html", null, true);
                echo "\">
                    </div>
                ...
                echo "\"
                         value=\"";
                // line 179
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "config", array()), "delete_reports_keep_week_reports", array()), "html", null, true);
                echo "\">
                    </div>
                ...
                echo ")\"
                         value=\"";
                // line 185
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "config", array()), "delete_reports_keep_month_reports", array()), "html", null, true);
                echo "\">
                    </div>
                ...
                echo ")\"
                         value=\"";
                // line 191
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "config", array()), "delete_reports_keep_year_reports", array()), "html", null, true);
                echo "\">
                    </div>
                ...
                echo "\"
                         value=\"";
                // line 197
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "config", array()), "delete_reports_keep_range_reports", array()), "html", null, true);
                echo "\">
                    </div>
                ...
                echo "\"
                         value=\"";
                // line 203
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "config", array()), "delete_reports_keep_segment_reports", array()), "html", null, true);
                echo "\">
                    </div>
                </div>
            </div>
        ...
        <div piwik-content-block id=\"scheduleSettingsHeadline\"
            ...
            <div id=\"deleteSchedulingSettings\">
                <div id=\"deleteSchedulingSettingsInlineHelp\" class=\"inline-help-node\">
                    ";
                // line 222
                if ($this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "lastRun", array())) {
                    echo "<strong>";
                    ...
                    echo ":</strong>
                        ";
                    // line 223
                    echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "lastRunPretty", array()), "html", null, true);
                    echo "
                        <br/>
                        <br/>
                    ";
                ...
                echo ":</strong>
                    ";
                // line 228
                echo $this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "nextRunPretty", array());
                echo "
                    <br/>
                    <br/>
                ...
                echo "\"
                     value=\"";
                // line 247
                echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "config", array()), "delete_logs_schedule_lowest_interval", array()), "html", null, true);
                echo "\"
            ...
            <div id=\"deleteDataEstimateSect\" class=\"form-group row\">
                ...
                <div class=\"col s12 m6\">
                    ";
                // line 264
                if (($this->getAttribute($this->getAttribute(($context["deleteData"] ?? $this->getContext($context, "deleteData")), "config", array()), "enable_auto_database_size_estimate", array()) == "0")) {
                    // line 265
...
<div piwik-content-block
    ...
    <p>
        ...
        echo \Piwik\piwik_escape_filter($this->env, ($context["optOutUrl"] ?? $this->getContext($context, "optOutUrl")), "html", null, true);
        echo "\"></iframe>";
    ...
    <pre piwik-select-on-focus>";
        // line 317
        echo \Piwik\piwik_escape_filter($this->env, ($context["iframeOptOut"] ?? $this->getContext($context, "iframeOptOut")), "html");
        echo "</pre>
    <p>
        ";
        // line 319
        echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("CoreAdminHome_OptOutExplanationBis", (("<a href='" . ($context["optOutUrl"] ?? $this->getContext($context, "optOutUrl"))) . "' rel='noreferrer' target='_blank'>"), "</a>"));
        echo "
    </p>
</div>
";
...
{% endblock %}
", "@PrivacyManager/privacySettings.twig", "/var/www/html/php-piwik/plugins/PrivacyManager/templates/privacySettings.twig");
    }
}
