...
class __TwigTemplate_17d2c99e2ed859c974e43dadaa21c3f34ef4cd3cc7f2ebf260d9f7da86d314ed extends Twig_Template
{
                ...
                echo "...\" id=\"start-automatic-update-geoip\"/>
                    ...
                    <div id=\"geoipdb-screen2-download\" ng-show=\"locationUpdater.showFreeDownload\">
                        <div piwik-progressbar
                             label=\"";
                // line 135
                echo \Piwik\piwik_escape_filter($this->env, twig_jsonencode_filter((call_user_func_array($this->env->getFilter('translate')->getCallable(), array("UserCountry_DownloadingDb", (("<a href=\"" . ($context["geoLiteUrl"] ?? $this->getContext($context, "geoLiteUrl"))) . "\">GeoLiteCity.dat</a>"))) . "...")), "html", null, true);
                echo "\"
...
", "@UserCountry/adminIndex.twig", "/var/www/html/php-piwik/plugins/UserCountry/templates/adminIndex.twig");
    }
}
