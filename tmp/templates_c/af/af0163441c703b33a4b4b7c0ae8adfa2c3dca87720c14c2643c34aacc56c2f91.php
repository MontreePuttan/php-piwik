    ...
    <section class=\"loginSection row\">
        ...
        if (((array_key_exists("isValidHost", $context) && array_key_exists("invalidHostMessage", $context)) && (($context["isValidHost"] ?? $this->getContext($context, "isValidHost")) == false))) {
            ...
            echo "            <div class=\"contentForm loginForm\">
                ";
            // line 57
            $this->loadTemplate("@Login/login.twig", "@Login/login.twig", 57, "112508342")->display(array_merge($context, array("title" => call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Login_LogIn")))));
            // line 123
            echo "            </div>
            <div class=\"contentForm resetForm\" style=\"display:none;\">
                ";
            // line 125
            $this->loadTemplate("@Login/login.twig", "@Login/login.twig", 125, "468112089")->display(array_merge($context, array("title" => call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Login_ChangeYourPassword")))));
            // line 180
            echo "            </div>
        ";
        }
...
{% endblock %}
", "@Login/login.twig", "/var/www/html/php-piwik/plugins/Login/templates/login.twig");
    }
}


/* @Login/login.twig */
class __TwigTemplate_7afec855be95b855b3f7d53a56ef27362f53d4aa5f9fbce0221ff234cfe64ef4_112508342 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);
...
/* @Login/login.twig */
class __TwigTemplate_7afec855be95b855b3f7d53a56ef27362f53d4aa5f9fbce0221ff234cfe64ef4_468112089 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);
