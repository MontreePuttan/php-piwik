...
class __TwigTemplate_dbafa53958a02f83af5a2cc7694e154abb62b740806d68f5426e56a45b42698d extends Twig_Template
{
...
<div piwik-content-block
    ...
    <a href='";
        // line 132
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFunction('linkTo')->getCallable(), array(array("ignoreSalt" => ($context["ignoreSalt"] ?? $this->getContext($context, "ignoreSalt")), "action" => "setIgnoreCookie"))), "html", null, true);
...
{% endblock %}
", "@UsersManager/userSettings.twig", "/var/www/html/php-piwik/plugins/UsersManager/templates/userSettings.twig");
    }
}
